...
\resumeSubHeadingListStart
\item
{\textbf{\small{Programming Languages: }}
Python, C++, C\#, JavaScript \& TypeScript} \\
{\textbf{\small{Frameworks \& Tools: }}
PyTorch, React, Next.js, React Native \& Expo, PostgreSQL, vLLM, LangGraph, TensorRT-LLM, LangChain, Unity3D, Docker, GitHub Actions (CI/CD), WebSocket, FastAPI, Supabase, AWS, Google Firebase}
\resumeSubHeadingListEnd
